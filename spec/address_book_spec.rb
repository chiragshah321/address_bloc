 ...
 RSpec.describe AddressBook do
  let(:book) {AddressBook.new}
   ...
   describe "#add_entry" do
     ...
     #tests if csv is imported correctly
     ...
     it "searchs for AddressBook for Bill" do
       book.import_from_csv("entries.csv")
     ...
     it "searchs for AddressBook for Bob" do
       book.import_from_csv("entries.csv")
     ...
     it "searchs for AddressBook for Joe" do
       book.import_from_csv("entries.csv")
     ...
     it "searchs for AddressBook for Sally" do
       book.import_from_csv("entries.csv")
     ...
     it "searchs for AddressBook for Sussie" do
       book.import_from_csv("entries.csv")
    ...
    describe "#remove_entry" do
      it "removes entry using the name, phone_number, email address" do
       ...
       book.add_entry('Chirag Shah', '321.543.6818', 'chirag.shah@lovelace.com')
